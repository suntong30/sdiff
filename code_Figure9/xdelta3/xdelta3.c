...
extern long hash_time;
extern long search_time;
		   ...
		   usize_t pos)
{
  ...
  hash_time += (get_millisecs_now() - time);
}
...
XD3_TEMPLATE(xd3_string_match_) (xd3_stream *stream)
{
 ...
 restartloop:
  ...
  search_time += (get_millisecs_now() - time);
