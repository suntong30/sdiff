...
import com.google.archivepatcher.generator.Diff;
...
public class FileByFileV1DeltaGenerator implements DeltaGenerator {
   ...
   */
  @Override
  public void generateDelta(File oldFile, File newFile, OutputStream patchOut, String diffPath, String parameters)
    ...
    try (TempFileHolder deltaFriendlyOldFile = new TempFileHolder();
      ...
      Diff diff = new Diff();
      diff.deltaGenerate(deltaFriendlyOldFile.file, deltaFriendlyNewFile.file, deltaFile.file, diffPath, parameters);
