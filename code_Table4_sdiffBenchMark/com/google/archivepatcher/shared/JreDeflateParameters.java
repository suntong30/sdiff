...
public enum JreDeflateParameters {
  ...
  LEVEL9_7Z_WRAP(9,7,false),
  LEVEL7_7Z_WRAP(7,7,false),
  LEVEL5_7Z_WRAP(5,7,false),
  LEVEL3_7Z_WRAP(3,7,false),
  LEVEL1_7Z_WRAP(1,7,false),
  LEVEL9_7Z_NOWRAP(9,7,true),
  LEVEL7_7Z_NOWRAP(7,7,true),
  LEVEL5_7Z_NOWRAP(5,7,true),
  LEVEL3_7Z_NOWRAP(3,7,true),
  LEVEL1_7Z_NOWRAP(1,7,true);
  ...
  private JreDeflateParameters(int level, int strategy, boolean nowrap) {
    if (level < 1 || level > 9 || strategy < 0 || (strategy > 2 && strategy != 7)) {
  ...
  public static JreDeflateParameters of(int level, int strategy, boolean nowrap) {
    ...
    switch (id) {
      ...
      case 970:
        return LEVEL9_7Z_WRAP;
      case 971:
        return LEVEL9_7Z_NOWRAP;
      case 770:
        return LEVEL7_7Z_WRAP;
      case 771:
        return LEVEL7_7Z_NOWRAP;
      case 570:
        return LEVEL5_7Z_WRAP;
      case 571:
        return LEVEL5_7Z_NOWRAP;
      case 370:
        return LEVEL3_7Z_WRAP;
      case 371:
        return LEVEL3_7Z_NOWRAP;
      case 170:
        return LEVEL1_7Z_WRAP;
      case 171:
        return LEVEL1_7Z_NOWRAP;
      default:
